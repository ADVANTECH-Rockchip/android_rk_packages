...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setStringSummary(KEY_BOARD_VERSION, SystemProperties.get("ro.setting.board_version", getResources().getString(R.string.device_info_default)));
        setStringSummary(KEY_OS_VERSION, SystemProperties.get("ro.setting.os_version", getResources().getString(R.string.device_info_default)));
    }
